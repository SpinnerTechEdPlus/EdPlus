...
public class UpdateNiveauForm extends SideMenuBaseForm {
    ...
    public UpdateNiveauForm(Resources res, Niveau n, Form previous) {
        ...
        setTitle("modifier un niveau");
        setLayout(BoxLayout.y());

        Form current = this;
        TextField tfNom = new TextField(n.getNom(), "nom");
        TextField tfniv = new TextField(String.valueOf(n.getNivScolaire()), "Le niveau scolaire en chiffres");
        int id = n.getId();
        Button btnValider = new Button("modifier un Niveau");
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                } else if (!Dialog.show("Modifier", "Voulez vous vraiment modifier ce niveau?", "Non", "OUI")) {
