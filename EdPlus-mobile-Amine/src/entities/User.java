...
public class User {
   ...
   // private String username_canonical;
    ...
    private User EcoleUser;
    //private int matiere_id;
    //private int classe_id;
    //private String searchName;
    //private int tel;

    public User getEcoleUser() {
        return EcoleUser;
    }

    public void setEcoleUser(User EcoleUser) {
    ...
    public User(int id, String username, String email, String password, int enabled,Date birthDate ) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.password = password;
      ...
      public User(int id, String username, String email, String password, int enabled,Date birthDate,int user_id ) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.password = password;
     ...
     public User(int id, String username, String email, String password, int enabled,Date birthDate,User ecole ) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.password = password;
