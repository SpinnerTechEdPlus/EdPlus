 ...
 */
package com.mycompany.myapp.gui.Professeur;
 ...
 * @author Shai Almog
 */
public abstract class SideMenuProfesseur extends Form {
    
    String roleProf="professeur";
        String roleEtu="etudiant";

    public SideMenuProfesseur(String title, Layout contentPaneLayout) {
        super(title, contentPaneLayout);
    }

    public SideMenuProfesseur(String title) {
        super(title);
    }

    public SideMenuProfesseur() {
    }

    public SideMenuProfesseur(Layout contentPaneLayout) {
    ...
    public void setupSideMenu(Resources res) {
        ...
        getToolbar().addMaterialCommandToSideMenu("  Home", FontImage.MATERIAL_DASHBOARD, e -> new DetailedProfesseur(res,this,UserSession.getUser(),UserSession.getUser().getRoles()));
        getToolbar().addMaterialCommandToSideMenu("  attribuer note", FontImage.MATERIAL_PEOPLE, e ->{});
