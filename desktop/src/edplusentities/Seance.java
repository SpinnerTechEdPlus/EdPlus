...
public class Seance {
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.salle == other.salle && this.jour.equals(other.jour) && this.debut.compareTo(other.fin) < 0 ) || 
                (this.classe == other.classe && this.jour.equals(other.jour) && this.debut.compareTo(other.fin) < 0 ) ||
                ( this.professeur == other.professeur && this.jour.equals(other.jour) && this.debut.compareTo(other.fin) < 0 ))
