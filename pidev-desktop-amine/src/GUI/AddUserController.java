...
public class AddUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            user = SU.readAll("a:1:{i:0;s:15:\"ROLE_PROFESSEUR\";}",UserSession.getUser().getId());
    ...
    private void AjouterProfesseur(ActionEvent event) {
        ...
        try {
            ...
            if (testEmail && testPW) {
                ...
                User user = new User(username, email, passCrypt, enable, role, username, matiereId,userId);
                ...
                userList = SU.readAll("a:1:{i:0;s:15:\"ROLE_PROFESSEUR\";}",UserSession.getUser().getId());
    ...
    private void SortByMatiere(ActionEvent event) {
        ...
        try {
            ...
            ObservableList<User> userList;
            int userId=UserSession.getUser().getId();
            userList = SU.readByMatiere("a:1:{i:0;s:15:\"ROLE_PROFESSEUR\";}", matiereId,userId);
