...
public class AddUserEtudiantController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            user = SU.readAll("a:1:{i:0;s:13:\"ROLE_ETUDIANT\";}",UserSession.getUser().getId());
    ...
    private void AjouterEtudiant(ActionEvent event) {
        try {
            ...
            if (testEmail && testPW) {
                ...
                User user = new User(username, username, email, email, passCrypt, enable, role, classeId,userId);
                SU.ajouterEtu(user);
                ...
                userList = SU.readAll("a:1:{i:0;s:13:\"ROLE_ETUDIANT\";}",UserSession.getUser().getId());
    ...
    private void SortByClasse(ActionEvent event) {
        try {
            ...
            userList = SU.readByClasse("a:1:{i:0;s:13:\"ROLE_ETUDIANT\";}", classeId,userId);
