...
public class ServiceUser implements Iservice<User>{
  ...
  //  pre.setInt(11, u.getClasse_id());
   ...
   // pre.setInt(13, u.getTel());
    ...
    PreparedStatement pre=con.prepareStatement("INSERT INTO `edplus`.`fos_user` ( `username`,`username_canonical`,`email`,`email_canonical`,`password`,`enabled`,`roles`, `searchName`, `matiere_id`,`user_id`) VALUES ( ?, ?, ? , ?, ?, ?,?,?,?,?);");
  ...
  //  pre.setInt(11, u.getClasse_id());
   ...
   // pre.setInt(13, u.getTel());
    ...
    PreparedStatement pre=con.prepareStatement("INSERT INTO `edplus`.`fos_user` ( `username`,`username_canonical`,`email`,`email_canonical`,`password`,`enabled`,`roles`, `classe_id`,`user_id` ) VALUES ( ? , ?, ?, ?,?,?,?,?,?);");
   ...
   // pre.setInt(13, u.getTel());
    pre.executeUpdate();
     ...
     @Override
    public ObservableList<User> readAll(String s,int userId) throws SQLException {
    ObservableList<User> arr=FXCollections.observableArrayList();
    String req = "select * from fos_user where roles =? and user_id =?";
   ...
   /* @Override
        ...
        try {
         preparedStatement = DataBase.getInstance().getConnection().prepareStatement(req);
            ...
            while (resultSet.next()) {
                 ...
                 System.out.println("rooole"+UserSession.getUser().getRoles());
    ...
    return arr;
     ...
     public ObservableList<User> readByMatiere(String s,int m,int userId) throws SQLException {
    ObservableList<User> arr=FXCollections.observableArrayList();
    String req = "select * from fos_user where roles =? and matiere_id =? and user_id=?";
    PreparedStatement preparedStatement;
    ...
    return arr;
      ...
      public int getClasseId(String s) throws SQLException {
       ...
       public ObservableList<User> readByClasse(String s,int m,int userId) throws SQLException {
    ObservableList<User> arr=FXCollections.observableArrayList();
    String req = "select * from fos_user where roles =? and classe_id =? and user_id =?";
    PreparedStatement preparedStatement;
