...
public class WalkthruForm extends Form {
    ...
    public WalkthruForm(Resources res) {
        ...
        if (Etudiant.examens.size() > 0) {
            
        int currentTheme = 1;
        for (Examen e : Etudiant.examens) {
            ...
            Container tab1 = BorderLayout.centerAbsolute(BoxLayout.encloseY(
                    notesPlaceholder,
                    new Label(e.getMatiereName() + " - Semestre " + e.getSemestre(), "WalkthruWhite"),
                    new Label("Le " + e.getHoraire(), "WalkthruWhite"),
                    new Label("Salle  " + e.getSalleName(), "WalkthruWhite"),
                    bottomSpace
            ));
...

            {
                ...
                Container tab1 = BorderLayout.centerAbsolute(BoxLayout.encloseY(
                        notesPlaceholder,
                        new Label("Calendrier Examen Vide!", "WalkthruWhite"), 
                        bottomSpace
                ));
