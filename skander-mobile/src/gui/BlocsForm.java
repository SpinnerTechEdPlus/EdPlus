...
public class BlocsForm extends SideMenuBaseForm {
    
        int tot = 0 ;
    public BlocsForm(Resources res) {
        super(BoxLayout.y());
      ...
      //  profilePicLabel.setMask(mask.createMask());
        ...
        Button skip = new Button("Statistiques");
        skip.setUIID("SkipButton");
        skip.addActionListener(e -> new StatsBlocsForm(res).show());
        add(skip);
        ...
        add(new Label("Les blocs", "TodayTitle"));
        ...
        i = 1 - i; 
        addButtonBottom(arrowDown, b.getNom()+" -> "+b.getNbetages()+" etages", colors[i], false);
